...
base_url = "https://factcheck.afp.com/list/all/all/all/38563/285?page="

# Define the range of pages you want to scrape
start_page = 1
end_page = 14  # Change this to the last page you want to scrape
