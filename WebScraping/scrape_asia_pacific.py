...
base_url = "https://factcheck.afp.com/list/all/all/all/38561/22?page="

# Define the range of pages you want to scrape
start_page = 1
end_page = 222  # Change this to the last page you want to scrape
...
csv_file = 'data_asia_pacific.csv'
